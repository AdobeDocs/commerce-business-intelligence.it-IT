...
*In questo caso, è possibile che la tabella non contenga tutti i clienti. Contatta il [team di supporto](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies) per assicurarti che le analisi dei clienti includano tutti i clienti.*
...
* **Esempio di report**: numero di acquisti effettuati il 2° e il 3° anno
  ...
  * **[!UICONTROL Group By]**: `Customer's Order Number`, quindi selezionare `2` e `3`
  ...
  ![Grafico che mostra la seconda e la terza analisi degli acquisti per l&#39;anno scorso](../../assets/2nd_and_3rd_purchases_last_year.png)
