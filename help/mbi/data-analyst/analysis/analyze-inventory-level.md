...
description: Crea un dashboard per monitorare i livelli di inventario correnti in Commerce Intelligence. Le istruzioni riguardano sia le configurazioni di account legacy che quelle nuove dell’architettura.
