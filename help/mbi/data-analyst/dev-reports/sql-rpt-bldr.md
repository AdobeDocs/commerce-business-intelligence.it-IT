...
Per modificare un report, fare clic sull&#39;icona a forma di ingranaggio (![](../../assets/gear-icon.png)) nell&#39;angolo superiore destro di un grafico basato su [!DNL SQL] e fare clic su **[!UICONTROL Edit]**.
