...
description: Riduci il tempo del ciclo di aggiornamento di Commerce Intelligence in modo che le dashboard riflettano più rapidamente i dati più recenti. Scopri cosa influisce sulla velocità di sincronizzazione e come migliorarla.
...
Se il tempo di aggiornamento sembra ancora lento anche dopo l&#39;implementazione di queste raccomandazioni, [contatta il team di supporto](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies).
